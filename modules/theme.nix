...

{
  stylix = {
    ...
    # Cursor — your uploaded Windows_11_dark set, converted to XCursor
    # (pkgs.win11-dark-cursors overlay; CI builds it to verify conversion).
    # Prefer Bibata? set package = pkgs.bibata-cursors; name = "Bibata-Modern-Classic";
    cursor = {
